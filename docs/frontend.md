...
app/
  ...
  (app)/
    ...
    (tabs)/
      ...
      settings/            # "Settings" tab — gear icon; grouped list of subview rows (Account, Appearance, Tasks, Calendars, Habits, Journal, Notes, Licenses). Log out lives in the Account subview; Appearance is the theme picker; the rest are placeholders
