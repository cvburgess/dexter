        ...
        <View
          style={[
            styles.hero,
            {
              ...
              // A measure, not clearance: run to the step's own edges the
              // sentence sets one very long centered line, and pulling it in
              // makes it wrap as a stanza. The hero's alone — the agenda rows
              // and cards below want the full width.
