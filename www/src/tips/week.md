...
To add an existing task to a day, either drag a task into the task list from the
quick planner or use the <i class="ph-bold ph-dots-three-outline-vertical"></i>
button to schedule the task for that day.
