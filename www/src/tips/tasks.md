...
Tap a task's title to edit it in place. The same works for subtasks. Titles are
saved when you tap away or press return, and a title left empty simply reverts —
a task without a name would be impossible to find again.

## Subtasks

Some tasks are really a short checklist. Rather than cluttering your day with
...
Because priority is such an important part of the [Dexter Method](/method) the
main styling of task cards is derived from their priority.
...
Make a list for work, a list for chores, a list for hobbies, a list for
projects - whatever makes sense in your brain.
