...
The toolbar enables quick navigation and access to tools without leaving the day
view.

![Toolbar](/assets/tips/day-toolbar.png)

- **The date**: Click on the date to open the date picker, click it again to
  come back to today
...
The day view will show only the tasks scheduled for today (or the day you
choose).
...
To add an existing task to the day, use the <i class="ph-bold ph-plus"></i>
button on a quick planner row. On a wide screen you can also drag the task
straight out of the quick planner and drop it on the task list, or drag it back
onto the quick planner to unschedule it.
...
Look through all your tasks as you plan your day with easy access to filtering,
